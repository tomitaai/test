...
<a href="{{ url('proposal2') }}" class="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100">
    ...
    <img alt="material" class="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" src = "{{asset('storage/materials/1.png') }}">
