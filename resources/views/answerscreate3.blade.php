<x-app-layout>
  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
	...
	<div class="max-w-sm rounded overflow-hidden shadow-lg mx-auto my-8 border border-gray-200 bg-white">
		...
		<form action="{{ url('answers3') }}" method="POST" enctype="multipart/form-data" class="w-full max-w-lg">
			@csrf
			...
			<div class="px-6 py-4">
				<div class="text-xl mb-2">
					...
					<div class="appearance-none block w-full text-gray-700 rounded py-3 px-4 mb-3 leading-tight text-sm">
					    ご家族のモットーや大切にしていることは何ですか？
					</div>
					<input name="question" value="ご家族のモットーや大切にしていることは何ですか？" type="hidden">
