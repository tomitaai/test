<x-app-layout>
    ...
    <div class="rounded overflow-hidden shadow-lg mx-auto m-6 mt-border border-gray-200 bg-white">
        ...
        <div class="rounded flex h-full items-center mb-3">
          ...
          <span class="title-font font-medium">Point （生後2週間）</span>
        </div>

        <p class="text-base text-gray-700 text-sm">
            気づけば、お子様のピンショットばかり...ということも多いです。産後の体調の変化や睡眠不足などで慌ただしい時期かと思いますが、ご家族の様子も一緒に撮影いただくことをおすすめします。</br></br>
            育児でてんてこ舞いな様子をのこしておくのも、意外といい想い出になるかもしれません。
        </p>
      </div>
    </div>
    </div>
