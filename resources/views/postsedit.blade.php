...
<x-app-layout>
  ...
  <div class="px-6 py-4">
    <div class="text-xl mb-2">
        ...
        <input name="event_name" value="{{ $post->event_name }}" 
        class="appearance-none block w-full text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none bg-gray-100 focus:border-gray-500" type="text" placeholder="">
        </div>
